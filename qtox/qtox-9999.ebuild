...
src_prepare() {
    epatch "$FILESDIR/widget.style.h.patch"
    epatch "$FILESDIR/widget.style.cpp.patch"
    epatch "$FILESDIR/chatlog.chatmessage.cpp.01.patch"
    epatch "$FILESDIR/chatlog.chatmessage.cpp.02.DASH.patch"
    epatch "$FILESDIR/chatArea.innerStyle.css.patch"
	epatch_user
}
